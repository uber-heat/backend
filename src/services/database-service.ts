...
import createHeaterModel, { HeaterInstance } from '../models/heater-model';
...
export default class DatabaseService extends Service {
    ...
    public readonly heaters: Model<HeaterInstance>;
    ...
    public constructor(container: ServiceContainer) {
        ...
        this.heaters = createHeaterModel(container, this.mongoose);
    }
